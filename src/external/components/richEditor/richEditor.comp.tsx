...
const formats = [
  ...
  'list', 'bullet', 'color', 'text-align', 'align',
  'link'
];
  ...
  toolbar: {
    container: [
      [
        ...
        {'color': []}, 'bold', 'italic', 'underline',/* 'strike', */ {'list': 'ordered'}, {'list': 'bullet'}, 'link'
      ]
    ]
  },
  clipboard: {
...
const modulesWithImage = {
  ...
  toolbar: {
    ...
    handlers: {
      ...
      uimage: function() {
        const opener: HTMLElement | null = document.querySelector('.rich-editor-wrapper .assets-gallery-opener');
...
export const RichEditorWithImages = (props: IRichEditorWithImageProps) => {
  const { onChange, onKeyDown, html, imageUploadEnabled, assetApiBaseUrl, pluginId } = props;
  const [fromInit, setFromInit] = useState<boolean>(true);
