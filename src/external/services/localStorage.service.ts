...
class LocalStorageService {
  ...
  constructor() {
    ...
    try {
      this.isLocalStorageSupported = typeof window !== 'undefined' && !!window.localStorage;
    } catch (e) {}
  }
  ...
  private getPluginStorage(): ILocalStorageObject {
    ...
    return JSON.parse(window.localStorage.getItem(`${this.prefix}_${this.pluginId}`) || '{}');
  }
  ...
  private setPluginStorage(value: ILocalStorageObject): ILocalStorageObject {
    ...
    window.localStorage.setItem(`${this.prefix}_${this.pluginId}`, JSON.stringify(value));
