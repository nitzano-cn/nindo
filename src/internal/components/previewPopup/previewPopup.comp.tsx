...
export const PreviewPopup = (props: PreviewPopupProps<any>) => {
  ...
  const [iframeDimensions, setIframeDimensions] = useState<{ width: null | number }>({
    width: null,
  });
  ...
  return (
    ...
    >
      ...
      <div className="preview-wrapper">
        ...
        <div className="iframe-wrapper" style={{ width: iframeDimensions.width ? `${iframeDimensions.width}px` : '' }}>
          <iframe 
