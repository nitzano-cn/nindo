...
const StarSvg = ({ icon }: { icon: string }) => {
  ...
  return (
    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="15" cy="15" r="13.5" stroke="black" stroke-opacity="0.2" stroke-width="3" />
      <path d="M11 21L15 17L19 21L21 19L17 15L21 11L19 9L15 13L11 9L9 11L13 15L9 19L11 21Z" fill="black" fill-opacity="0.3" />
    </svg>
  )
};
