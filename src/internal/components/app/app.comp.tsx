...
import { IAppConfig, TPluginEditorProps, TPluginViewerProps } from '../../../external/types/app.types';
...
export const App = ({ appConfig }: IAppProps<any>) => {
	...
	const editorProps = extractViewerEditorProps<TPluginEditorProps<any>>(appConfig?.editor?.props, pluginData);
	const viewerProps = extractViewerEditorProps<TPluginViewerProps<any>>(appConfig?.viewer?.props, pluginData);
