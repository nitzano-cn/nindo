...
import { EditorActionTypes, IEditorState } from '../../external/types/editor.types';
import { IPlugin } from '../../external/types/plugin.types';

export const historyChangeAction = (items: IPlugin<any>[], newIndex: number, firstUpdate: boolean) => ({
...
export const historyChange = (data: IPlugin<any>, firstUpdate: boolean = false) => {
  return (dispatch: Dispatch<any>, getState: Function) => {
    ...
    dispatch(historyChangeAction(historyCopy, historyCopy.length - 1, firstUpdate));
  };
};