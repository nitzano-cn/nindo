...
export const TemplatesPopup = ({
	...
	closeCallback,
	onSelect,
}: IPluginTemplatesPopupProps) => {
	const [selected, setSelected] = useState<IPluginTemplate | null>({
		...blankTemplate,
	});
			...
			<section>
				...
				<div className="templates-container">
					...
					<div className="templates-wrapper">
						{[{ ...blankTemplate }, ...pluginTemplates].map(
				...
				<div className="buttons-wrapper">
					<Button color="green" onClick={save} disabled={!selected}>
						Select & Continue
					</Button>
				</div>
			</section>
