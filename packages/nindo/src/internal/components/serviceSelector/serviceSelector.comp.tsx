...
import {
	NinjaIcon,
	SystemIcon,
} from '../../../external/components/icon/icon.comp';
...
export const ServiceSelector = ({
	...
	const [serviceSelectorOpened, setServiceSelectorOpened] =
	...
	return (
		<H2 className="center">
			...
			>
				<span>
					{getPluginNameByService(planData.services[0], planData.name)}
				</span>
				&nbsp;
				{showServices && (
					<>
						...
						>
							{pluginsList
								...
								.map((listing) => (
									<div
										key={`plugin_listing_${listing.name}`}
										className="plugin-listing"
										onClick={() => onChange(listing.serviceName)}
									>
